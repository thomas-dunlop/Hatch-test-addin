...
class Utils {
    ...
    static async getNPMMajorVersion(logger) {
        try {
            const output = await common_1.cpUtils.executeCommand(undefined, logger, { shell: true }, "npm", "--version");
    ...
    static async getNodeVersion() {
        try {
            const output = await common_1.cpUtils.executeCommand(undefined, undefined, undefined, "node", "--version");
