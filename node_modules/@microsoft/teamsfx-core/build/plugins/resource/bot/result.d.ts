...
export declare class FxBotPluginResultFactory {
    ...
    static UserError(errorName: string, errorMessage: [string, string], innerError?: any, helpLink?: string): FxResult;
    static SystemError(errorName: string, errorMessage: [string, string], innerError?: any): FxResult;
