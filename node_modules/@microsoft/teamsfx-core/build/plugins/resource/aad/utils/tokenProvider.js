...
class GraphInstance {
    async getToken(tokenProvider) {
        var _a;
        const tokenRes = await ((_a = tokenProvider.m365) === null || _a === void 0 ? void 0 : _a.getAccessToken({ scopes: common_1.GraphScopes }));
        const token = (tokenRes === null || tokenRes === void 0 ? void 0 : tokenRes.isOk()) ? tokenRes.value : undefined;
        return token;
    }
    async getTenant(tokenProvider) {
        var _a;
        const tokenObjectRes = await ((_a = tokenProvider.m365) === null || _a === void 0 ? void 0 : _a.getJsonObject({ scopes: common_1.GraphScopes }));
...
class AppStudioInstance {
    async getToken(tokenProvider) {
        var _a;
        const tokenRes = await ((_a = tokenProvider.m365) === null || _a === void 0 ? void 0 : _a.getAccessToken({ scopes: common_1.AppStudioScopes }));
        const token = (tokenRes === null || tokenRes === void 0 ? void 0 : tokenRes.isOk()) ? tokenRes.value : undefined;
        return token;
    }
    async getTenant(tokenProvider) {
        var _a;
        const tokenObjectRes = await ((_a = tokenProvider.m365) === null || _a === void 0 ? void 0 : _a.getJsonObject({ scopes: common_1.AppStudioScopes }));
        const tokenObject = (tokenObjectRes === null || tokenObjectRes === void 0 ? void 0 : tokenObjectRes.isOk()) ? tokenObjectRes.value : undefined;
        if (!tokenObject) {
            return undefined;
        }
