...
function shouldSkipWriteEnvInfo(method, res) {
    return (res.isErr() &&
        (res.error.name === "CancelProvision" ||
            res.error.name === constants_1.SolutionError.FailedToUpdateAzureParameters ||
            res.error.name === constants_1.SolutionError.FailedToBackupFiles ||
