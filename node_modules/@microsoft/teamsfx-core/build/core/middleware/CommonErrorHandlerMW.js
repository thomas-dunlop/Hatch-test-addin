...
const solutionGlobalVars_1 = require("../../plugins/solution/fx-solution/v3/solutionGlobalVars");
    ...
    return async (ctx, next) => {
        try {
            ...
            if (option === null || option === void 0 ? void 0 : option.telemetry) {
                ...
                option.telemetry.properties[telemetry_1.TelemetryProperty.AppId] = solutionGlobalVars_1.solutionGlobalVars.TeamsAppId || "";
                result.isOk()
                    ? telemetry_1.sendTelemetryEvent(option.telemetry.component, event, option.telemetry.properties)
