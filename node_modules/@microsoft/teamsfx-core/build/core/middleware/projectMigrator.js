...
const utils_4 = require("../../common/utils");
...
async function getMultiEnvFolders(projectPath) {
    ...
    const templateAppPackage = path_1.default.join(await utils_4.getProjectTemplatesFolderPath(projectPath), teamsfx_api_1.AppPackageFolderName);
