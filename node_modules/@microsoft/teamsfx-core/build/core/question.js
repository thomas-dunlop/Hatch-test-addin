...
function createCapabilityQuestion() {
    ...
    if (featureFlags_1.isBotNotificationEnabled()) {
        ...
        const newBots = featureFlags_1.isWorkflowBotEnabled()
            ? [question_1.NotificationOptionItem, question_1.CommandAndResponseOptionItem, question_1.WorkflowOptionItem]
            : [question_1.NotificationOptionItem, question_1.CommandAndResponseOptionItem];
        staticOptions = [
            ...newBots,
...
function createCapabilityQuestionPreview() {
    ...
    if (tools_1.isExistingTabAppEnabled()) {
        staticOptions.splice(newBots.length, 0, question_1.ExistingTabOptionItem);
    }
    return {
        name: CoreQuestionNames.Capabilities,
...
function validateCapabilities(inputs) {
    ...
    let result = validateConflict([
        ...
        new Set([question_1.WorkflowOptionItem.id]),
    ], set);
    if (result)
        return result;
