...
class ApimPluginConfig {
    constructor(config, envName) {
        if (!config) {
            const cname = core_1.isV3() ? constants_1.TeamsToolkitComponentV3.AadPlugin : constants_1.TeamsToolkitComponent.ApimPlugin;
    ...
    getValue(key, namingRule) {
        ...
        if (namingRule && value) {
            ...
            if (message) {
                throw error_1.BuildError(error_1.InvalidConfigValue, core_1.isV3() ? constants_1.TeamsToolkitComponentV3.ApimPlugin : constants_1.TeamsToolkitComponent.ApimPlugin, key, message);
            }
        }
        return value;
    }
    ...
    checkAndGet(key) {
        const value = error_1.AssertConfigNotEmpty(core_1.isV3() ? constants_1.TeamsToolkitComponentV3.ApimPlugin : constants_1.TeamsToolkitComponent.ApimPlugin, key, this.getValue(key), this.envName);
        return value;
    }
}
...
class FunctionPluginConfig {
    ...
    checkAndGet(key) {
        return checkAndGetOtherPluginConfig(this.configOfOtherPlugins, core_1.isV3() ? constants_1.TeamsToolkitComponentV3.FunctionPlugin : constants_1.TeamsToolkitComponent.FunctionPlugin, key, this.envName);
    }
}
...
class AadPluginConfig {
    ...
    checkAndGet(key) {
        return checkAndGetOtherPluginConfig(this.configOfOtherPlugins, core_1.isV3() ? constants_1.TeamsToolkitComponentV3.AadPlugin : constants_1.TeamsToolkitComponent.AadPlugin, key, this.envName);
    }
}
