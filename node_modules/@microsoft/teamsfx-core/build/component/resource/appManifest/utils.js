...
class ManifestUtils {
    ...
    async addCapabilities(inputs, capabilities) {
        var _a, _b, _c, _d;
                    ...
                    if (capability.snippet) {
                        ...
                        if (capability.existingApp) {
                            ...
                            appManifest.composeExtensions =
                                appManifest.composeExtensions.concat(constants_2.COMPOSE_EXTENSIONS_TPL_V3);
                        }
                    }
                    break;
    ...
    async getManifest(projectPath, envInfo, ignoreEnvStateValueMissing, telemetryProps) {
        ...
        if (isLocalDebug || ((_a = manifest.validDomains) === null || _a === void 0 ? void 0 : _a.length) === 0) {
            const validDomains = [];
            const tabEndpoint = (_b = envInfo.state[constants_4.ComponentNames.TeamsTab]) === null || _b === void 0 ? void 0 : _b.endpoint;
            const tabDomain = (_c = envInfo.state[constants_4.ComponentNames.TeamsTab]) === null || _c === void 0 ? void 0 : _c.domain;
            if (tabDomain) {
            ...
            const botId = (_d = envInfo.state[constants_4.ComponentNames.TeamsBot]) === null || _d === void 0 ? void 0 : _d.botId;
            const botDomain = (_e = envInfo.state[constants_4.ComponentNames.TeamsBot]) === null || _e === void 0 ? void 0 : _e.validDomain;
            if (botId) {
                if (!botDomain) {
