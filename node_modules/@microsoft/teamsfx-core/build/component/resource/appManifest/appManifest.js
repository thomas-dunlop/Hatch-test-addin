...
let AppManifest = class AppManifest {
    ...
    async addCapability(inputs, capabilities) {
        return utils_2.manifestUtils.addCapabilities(inputs, capabilities);
    }
    ...
    async publish(context, inputs, actionCtx) {
        ...
        if (inputs.platform === teamsfx_api_1.Platform.VSCode &&
            ...
            try {
                const appPackagePath = await appStudio_2.buildTeamsAppPackage(context.projectSetting, inputs.projectPath, ctx.envInfo, false, actionCtx.telemetryProps);
