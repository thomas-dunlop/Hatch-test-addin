...
class DeployUtils {
    ...
    async deployAadFromVscode(context, inputs) {
        ...
        const subscriptionResult = await this.checkDeployAzureSubscription(context, context.envInfo, context.tokenProvider.azureAccountProvider);
        ...
        if (result.kind === "success") {
            ...
            context.logProvider.info(msg);
            return teamsfx_api_1.err(util_1.sendErrorTelemetryThenReturnError(constants_2.SolutionTelemetryEvent.Deploy, result.error, context.telemetryReporter));
        }
    }
