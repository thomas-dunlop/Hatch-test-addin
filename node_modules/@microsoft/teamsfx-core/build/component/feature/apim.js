...
let ApimFeature = class ApimFeature {
    constructor() {
        this.name = constants_1.ComponentNames.APIMFeature;
    }
    async add(context, inputs) {
        const component = workflow_1.getComponent(context.projectSetting, constants_1.ComponentNames.APIM);
        if (component)
        ...
        {
            const apimResource = typedi_1.Container.get(constants_1.ComponentNames.APIM);
    ...
    async generateCode(context, inputs, actionContext) {
        ...
        if (answer.validate) {
            await answer.validate(constants_2.PluginLifeCycle.Scaffold, apimConfig, inputs.projectPath);
        }
        answer.save(constants_2.PluginLifeCycle.Scaffold, apimConfig);
        await ((_a = actionContext === null || actionContext === void 0 ? void 0 : actionContext.progressBar) === null || _a === void 0 ? void 0 : _a.next(constants_2.ProgressMessages[constants_2.ProgressStep.Scaffold].Scaffold));
...
tslib_1.__decorate([
    lib_1.hooks([
        actionExecutionMW_1.ActionExecutionMW({
            ...
            progressTitle: constants_2.ProgressStep.Scaffold,
            progressSteps: Object.keys(constants_2.ProgressMessages[constants_2.ProgressStep.Scaffold]).length,
        }),
    ]),
...
ApimFeature = tslib_1.__decorate([
    typedi_1.Service(constants_1.ComponentNames.APIMFeature)
], ApimFeature);
