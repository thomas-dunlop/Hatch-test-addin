...
let BotCodeProvider = BotCodeProvider_1 = class BotCodeProvider {
    ...
    async generate(context, inputs, actionContext) {
        ...
        const botFolder = (_a = inputs.folder) !== null && _a !== void 0 ? _a : (language === constants_2.ProgrammingLanguage.CSharp ? "" : strings_1.CommonStrings.BOT_WORKING_DIR_NAME);
    ...
    async build(context, inputs, actionContext) {
        ...
        if (language === constants_2.ProgrammingLanguage.TS) {
            ...
            try {
                await utils_1.execute("npm install", packDir, context.logProvider);
                await utils_1.execute("npm run build", packDir, context.logProvider);
            ...
            await utils_1.execute(`dotnet publish --configuration Release`, packDir, context.logProvider);
