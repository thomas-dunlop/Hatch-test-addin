...
function execute(command, workingDir, logger, env) {
    return new Promise((resolve, reject) => {
        ...
        child_process_1.exec(command, { cwd: workingDir, env: Object.assign(Object.assign({}, process.env), env) }, (error, stdout, stderr) => {
            logger === null || logger === void 0 ? void 0 : logger.debug(stdout);
            if (error) {
                logger === null || logger === void 0 ? void 0 : logger.error(`Failed to run command: "${command}" on path: "${workingDir}".`);
                if (stderr) {
