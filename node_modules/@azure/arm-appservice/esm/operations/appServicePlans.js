...
var updateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.AppServicePlanPatchResource), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.AppServicePlan
...
var updateVnetGatewayOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.VnetGateway), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.VnetGateway
...
var createOrUpdateVnetRouteOperationSpec = {
    ...
    requestBody: {
        parameterPath: "route",
        mapper: __assign(__assign({}, Mappers.VnetRoute), { required: true })
    },
    responses: {
        200: {
...
var beginCreateOrUpdateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "appServicePlan",
        mapper: __assign(__assign({}, Mappers.AppServicePlan), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.AppServicePlan
