...
var validatePurchaseInformationOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.AppServiceCertificateOrder), { required: true })
    },
    responses: {
        204: {},
        default: {
...
var updateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.AppServiceCertificateOrderPatchResource), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.AppServiceCertificateOrder
...
var updateCertificateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.AppServiceCertificatePatchResource), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.AppServiceCertificateResource
...
var reissueOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.ReissueCertificateOrderRequest), { required: true })
    },
    responses: {
        204: {},
        default: {
...
var renewOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.RenewCertificateOrderRequest), { required: true })
    },
    responses: {
        204: {},
        default: {
...
var retrieveSiteSealOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.SiteSealRequest), { required: true })
    },
    responses: {
        200: {
...
var beginCreateOrUpdateCertificateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "keyVaultCertificate",
        mapper: __assign(__assign({}, Mappers.AppServiceCertificateResource), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.AppServiceCertificateResource
