...
var updateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.AppServiceEnvironmentPatchResource), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.AppServiceEnvironmentResource
...
var updateMultiRolePoolOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.WorkerPoolResource), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.WorkerPoolResource
...
var beginCreateOrUpdateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "hostingEnvironmentEnvelope",
        mapper: __assign(__assign({}, Mappers.AppServiceEnvironmentResource), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.AppServiceEnvironmentResource
...
var beginChangeVnetOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.VirtualNetworkProfile), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.WebAppCollection
