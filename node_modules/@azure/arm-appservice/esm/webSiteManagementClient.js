...
var WebSiteManagementClient = /** @class */ (function (_super) {
    ...
    function WebSiteManagementClient(credentials, subscriptionId, options) {
        ...
        _this.staticSites = new operations.StaticSites(_this);
...
var generateGithubAccessTokenForAppserviceCLIAsyncOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.AppserviceGithubTokenRequest), { required: true })
    },
    responses: {
        200: {
...
var updatePublishingUserOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.User), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.User
...
var updateSourceControlOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.SourceControl), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.SourceControl
...
var verifyHostingEnvironmentVnetOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.VnetParameters), { required: true })
    },
    responses: {
        200: {
...
var moveOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.CsmMoveResourceEnvelope), { required: true })
    },
    responses: {
        204: {},
        default: {
...
var validateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.ValidateRequest), { required: true })
    },
    responses: {
        200: {
