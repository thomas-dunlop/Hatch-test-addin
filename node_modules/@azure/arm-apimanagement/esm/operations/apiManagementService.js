...
var checkNameAvailabilityOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.ApiManagementServiceCheckNameAvailabilityParameters), { required: true })
    },
    responses: {
        200: {
...
var beginRestoreOperationSpec = {
    ...
    requestBody: {
        parameterPath: "parameters",
        mapper: __assign(__assign({}, Mappers.ApiManagementServiceBackupRestoreParameters), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ApiManagementServiceResource
...
var beginCreateOrUpdateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "parameters",
        mapper: __assign(__assign({}, Mappers.ApiManagementServiceResource), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ApiManagementServiceResource
...
var beginUpdateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "parameters",
        mapper: __assign(__assign({}, Mappers.ApiManagementServiceUpdateParameters), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ApiManagementServiceResource
