...
var createOrUpdateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.AuthorizationServerContract), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.AuthorizationServerContract,
...
var updateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "parameters",
        mapper: __assign(__assign({}, Mappers.AuthorizationServerUpdateContract), { required: true })
    },
    responses: {
        204: {},
        default: {
