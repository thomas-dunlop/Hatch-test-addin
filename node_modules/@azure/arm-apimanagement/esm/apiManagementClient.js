...
var ApiManagementClient = /** @class */ (function (_super) {
    ...
    function ApiManagementClient(credentials, subscriptionId, options) {
        ...
        _this.apiRevision = new operations.ApiRevision(_this);
        ...
        _this.apiTagDescription = new operations.ApiTagDescription(_this);
        ...
        _this.cache = new operations.Cache(_this);
        ...
        _this.apiManagementServiceSkus = new operations.ApiManagementServiceSkus(_this);
        ...
        _this.gatewayHostnameConfiguration = new operations.GatewayHostnameConfiguration(_this);
        _this.gatewayApi = new operations.GatewayApi(_this);
        ...
        _this.issue = new operations.Issue(_this);
        _this.logger = new operations.Logger(_this);
        _this.namedValue = new operations.NamedValue(_this);
        ...
        _this.policyDescription = new operations.PolicyDescription(_this);
        ...
        _this.region = new operations.Region(_this);
        ...
        _this.userConfirmationPassword = new operations.UserConfirmationPassword(_this);
